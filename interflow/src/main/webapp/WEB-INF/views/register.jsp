            ...
            <form id="re" onsubmit="return false" action="##" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="regusername" name="username"
                           placeholder="长度1-20位字符，中文、数字、_ 、字母" autofocus="autofocus"/>
                </div>
                <div class="form-group">
                    密码:
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <input type="text" class="form-control" id="phone" style="width: 200px;margin-left: 15px"
                               placeholder="请输入手机号">
                        <button style="margin-left: 20px" type="button" onclick="getcode(this)" class="btn btn-primary"
                                id="getverifycode">
                            获取验证码
                        </button>
                    </div>
                ...
                <button type="button" id="register" class="btn btn-primary" onclick="registerUser()"
                        style="width: 100%">注册
                </button>
            </form>
        </div>
...
<script>
    ...
    function registerUser() {
        ...
        else if (confirmPassword == null || $.trim(confirmPassword) == '') {
            $("#regerror").text("确认密码不能为空！");
        }
        else if (confirmPassword != password) {
            $("#regerror").text("两次密码不一致！");
        }
        else if (email == null || $.trim(email) == '') {
            $("#regerror").text("邮箱不能为空！");
        }
        else if (!emailreg.test(email)) {
            $("#regerror").text("邮箱格式不正确！");
        } else if (verifycode == null || $.trim(verifycode) == '') {
